...
export const Utilitie = () => {
    return (
        <div>
            <div className="bg-clr mt_2 pt-5 pb-125">
                <Container className=" pt-5 my_container">
                    <p className="text-center fs-xxl white-F ff-azo fw-normal lh-108 mb-0 pb-1">
                        Utilities
                    </p>
                    <Row className=" align-items-cemter justify-content-center pt-5">
                        <Col lg={4} md={6} sm={6} className="col-12  ">
                            <div className="utiliti-box  p-4 mt-4 mt-lg-0 position-relative overflow-hidden">
                                <p
                                    className="utiliti-logo d-flex align-items-cenetr justify-content-center"
                                >
                                    <svg
                                        width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path d="M32.6654 4.6665L13.9987 4.6665C12.761 4.6665 11.574 5.15817 10.6989 6.03334C9.8237 6.90851 9.33203 8.09549 9.33203 9.33317L9.33203 46.6665C9.33203 47.9042 9.8237 49.0912 10.6989 49.9663C11.574 50.8415 12.761 51.3332 13.9987 51.3332L41.9987 51.3332C43.2364 51.3332 44.4234 50.8415 45.2985 49.9663C46.1737 49.0912 46.6654 47.9042 46.6654 46.6665L46.6654 18.6665L32.6654 4.6665Z"
                                        ...
                                        />
                                        <path
                                            d="M37.3346 30.3335L18.668 30.3335" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"
                                        />
                                        <path stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"
                                        />
                                        <path
                                ...
                                <span className="white-shadow-1 position-absolute"></span>
                                <span className="white-shadow-2 position-absolute"></span>
                            </div>
                        </Col>
                        <Col lg={4} md={6} sm={6} className="col-12 ">
                            <div className="utiliti-box  p-4 mt-4 mt-lg-0 position-relative overflow-hidden">
                                ...
                                <p className="fs-sm fw-normal card-clr ff-mon mb-0 lh-160 mw_330 text-center">
                                    Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae
                                    viverra amet et. Erat nam molestie. Vitae mollis lacus
                                    senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac
                                    sed tellus.
                        ...
                        <Col lg={4} md={6} sm={6} className="col-12 ">
                            <div className="utiliti-box p-4 mt-4 mt-lg-0 position-relative overflow-hidden">
                                ...
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg" className="svg-file"
                                        width="56"
                                        height="56"
                                        viewBox="0 0 56 56"
                                        fill="none"
