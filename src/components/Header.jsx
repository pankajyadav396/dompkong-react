...
import headlogo from "../assets/images/logo-img.png";
    ...
    return (
        <div>
            ...
            <div id="preloader" class="overflow-y-hidden  position-relative loader_bg ">
                <div class=" bg-black z-3 vh-100 d-flex align-items-center justify-content-center  position-fixed  top-0 start-0 w-100 ">
            ...
            {backTop ? (
                <button
                    onClick={moveToTop}
                    className="position-fixed border-0 topbtn btn-top bottom-0 end-0 me-2 mb-2 rounded-circle pointer z-2"
                >
            ...
            <section className="head-bg-img ">
                <div className="container my_container position-relative">
                    <div className="d-flex justify-content-center align-items-center">
                        <img src={headlogo} className='w-116' alt="#" />
                        <button className="position-absolute main-nav-btn fs-sm fw-normal ff-azo black-0 mb-0 main-btn lh-108 mt-1">
                            Connect Wallet
                        </button>
                    </div>
                    <div className="d-flex align-items-center justify-content-center gap-3 pt-4">
                        ...
                        <a href="//https/" className="app-icon">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                    ...
                    <div className="d-flex justify-content-center align-items-center pt-4 ">
                        <p className="fs-xxl fw-normal text-center white-F ff-azo lh-108 mw_30 pt-1 mb-0 text-uppercase">
                            WELCOME <span className="d-block"><span> To</span>
                                <span className="light-yellow head-underline"> DomPKong</span></span>
                        </p>
                    </div>
                    <div className="d-flex justify-content-center align-items-center ">
                        <p className="fs-sm fw-normal white-F ff-mon lh-160 mw_550 text-center mb-0 pt-4">
                            Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra
                            amet et. Erat nam molestie. Vita
                        </p>
                    </div>
                    <div className="d-flex align-items-center justify-content-center flex-wrap gap-4 pt-4">
