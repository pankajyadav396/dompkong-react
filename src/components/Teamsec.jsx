...
import teamone from "../assets/images/team-img-2.png";
import teamtwo from "../assets/images/team-img-1.png";
import teamthree from "../assets/images/team-img-3.png";
...
export const Teamsec = () => {
    return (
        <div className="bg-clr mt_2">
            <Container className="my_container pt-0">
                <p className="fs-xxl fw-normal white-F text-center ff-azo mb-0 pb-5">
                    Meet The Team
                </p>
